import manage from "../img/png/port-nav-2.png";
// Pictures
import first from "../img/png/bookmark.png";
import second from "../img/png/bookmark-2.png";
  ...
  return (
    <div>
      <div className="mb-[64px]">
        <img className="w-full min-h-[140px] first-bg mb-[115px]" src={manage} alt="" />
      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          <Link to={'/portfolio/manage'} className="flex strelka-1 gap-[25px] items-center">
          ...
          <Link to={'/portfolio/insure'} className="flex strelka-2 gap-[25px] items-center">
