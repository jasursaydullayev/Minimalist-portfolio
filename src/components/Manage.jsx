  ...
  return (
    <div>
      <div className="mb-[64px]">
        <img
          className="w-full min-h-[140px] first-bg mb-[115px]"
          src={manage}
          alt=""
        />
        <div className="flex footer-container gap-[125px]">
          ...
          <div className="h-full">
            ...
            <img
              className="mb-[32px] z-img w-full max-w-[635px] h-[400px] object-top"
              src={first}
              alt=""
            />
            <img className="mb-[64px]" src={second} alt="" />
          </div>
        </div>
      </div>
      <div>
        ...
        <div className="flex justify-between items-center">
          <Link to={"/portfolio/fylo"} className="flex strelka-1 gap-[25px] items-center">
